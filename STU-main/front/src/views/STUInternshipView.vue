<template>
  <div>
    <el-table :data="courseList" border style="width: 100%">
      ...
      <el-table-column prop="startData" label="实习开始时间" width="150">
      </el-table-column>
      <el-table-column prop="endData" label="实习结束时间" width="150">
      </el-table-column>
      <el-table-column prop="certifier" label="证明人" width="100">
      </el-table-column>
      <el-table-column prop="evaluate" label="实习期间评价情况" width="200">
      </el-table-column>
    </el-table>
  </div>
</template>
...
export default {
  ...
  methods: {
    async getAllStudentInternshipList() {
      try {
  ...
  created() {
    this.getAllStudentInternshipList();
  }
}
