        ...
        <div class="row" v-for="(time, timeIndex) in times" :key="timeIndex">
          ...
          <div class="cell" v-for="(day, dayIndex) in days" :key="dayIndex">
            ...
            <template v-if="course.course.courseType == '必修'">
              <div class="course">
              <div class="course-name">{{ course.course.courseName }}
              <br><br>

              </div>
              <div class="course-details">教师: {{ course.course.teacherName }}<br></div>
            ...
            <template v-if="course.course.courseType != '必修'">
              ...
              <div class="course-details">教师: {{ course.course.teacherName }}<br><br></div>
              <div class="course-details">地点: {{ course.course.place }}</div>
              </div>
            </template>
            </div>
