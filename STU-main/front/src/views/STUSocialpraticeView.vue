<template>
    ...
    <el-table :data="courseList" border style="width: 100%">
      ...
      <el-table-column prop="name" label="社会实践名称" width="110">
      </el-table-column>
      <el-table-column prop="unit" label="社会实践单位" width="110">
      </el-table-column>
      <el-table-column prop="content" label="实践内容" width="150">
      </el-table-column>
      <el-table-column prop="startData" label="开始时间" width="150">
      </el-table-column>
      <el-table-column prop="endData" label="结束时间" width="150">
      </el-table-column>
