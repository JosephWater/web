<template>
    <div>
      <div>
        <el-button style="margin-bottom: 10px; margin-top: 10px" @click="$router.push('/container/leaveList/createLeave')">增添请假申请</el-button>
      </div>
      <el-table :data="leaveList" border style="width: 100%">
        <el-table-column fixed prop="studentNum" label="学生学号" width="110">
        </el-table-column>
        <el-table-column prop="studentName" label="学生姓名" width="80">
        </el-table-column>
       
        <el-table-column prop="startData" label="离校时间" width="120">
        </el-table-column>
        <el-table-column prop="endData" label="返校时间" width="120">
        </el-table-column>
        <el-table-column prop="studentleaveReason" label="请假类型" width="100">
        </el-table-column>
        <el-table-column prop="studentleaveType" label="请假原因" width="250">
        </el-table-column>
        <el-table-column prop="approveStatus" label="批准状态" width="80">
        </el-table-column>
        <el-table-column prop="teacherNum" label="教职工号" width="90">
      </el-table-column>
      <el-table-column prop="teacherName" label="老师姓名" width="90">
      </el-table-column>
