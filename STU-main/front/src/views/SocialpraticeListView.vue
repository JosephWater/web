<template>
    <div>
      ...
      <el-table :data="courseList" border style="width: 100%">
        ...
        <el-table-column prop="unit" label="社会实践单位" width="100">
        </el-table-column>
        <el-table-column prop="content" label="实践内容" width="100">
        </el-table-column>
        <el-table-column prop="startData" label="实践开始时间" width="100">
        </el-table-column>
        <el-table-column prop="endData" label="实践结束时间" width="100">
        </el-table-column>
        <el-table-column prop="certifier" label="证明人" width="100">
        </el-table-column>
        <el-table-column prop="evaluate" label="实践期间评价情况" width="100">
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template slot-scope="scope">
            <el-button @click="deleteClick(scope.row)" type="danger" size="mini"
              >删除</el-button>
            <el-button  @click="$router.push('/container/socialpraticeList/createSocialpratice')"  size="mini"
              >编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
