...
<script>
import {updateTeacher} from '../../api/teachertable.ts'
...
export default {
  ...
  created() {
    ...
    this.form.id = this.teacherInfo.id;
    this.form.title = this.teacherInfo.title;
    this.form.degree = this.teacherInfo.degree;
    this.form.person = this.teacherInfo.person;
  }
}
</script>