...
<script>
import {updateStudent} from '../../api/studenttable.ts'
...
export default {
  ...
  created() {
    ...
    this.form.id = this.studentInfo.id;
    this.form.major = this.studentInfo.major;
    this.form.className = this.studentInfo.className;
    this.form.person = this.studentInfo.person;
  }
}
</script>