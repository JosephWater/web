    ...
    <div class="login-box2">
      ...
      <el-form :model="form" label-width="80px" :rules="rules2"  ref="form">
        ...
        <el-form-item label="用户名" prop="username">
          <el-input v-model="form.username" prefix-icon="el-icon-user" class="input-with-focus"></el-input>
        </el-form-item>
        <el-form-item label="姓名" prop="name">
          <el-input v-model="form.name" prefix-icon="el-icon-lock" class="input-with-focus"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input v-model="form.password" prefix-icon="el-icon-lock" class="input-with-focus"></el-input>
        </el-form-item>
      ...
      <el-form-item>
        <el-button
            ...
            @click="logiForm('form')"
            style="width: 220px ;font-size: 17px">注册
        </el-button>
      </el-form-item>
      <el-form-item style="front-size: 8px">
        <el-button style="font-size: 17px"
              type="primary"
              
              @click="$router.push('/login')"
              class="login-button">返回登录</el-button>
          </el-form-item>
      </el-form>
    </div>
  </div>
